...
@Config
public class SummerChassisUniversalControlClass {
    LinearOpMode opMode;
    DcMotor leftFront;
    DcMotor leftRear;
    DcMotor rightFront;
    ...
    public SummerChassisUniversalControlClass(boolean isDriverControl, boolean isFieldCentric, LinearOpMode opMode) {
